...
foreach ($itemsRaw as $it) {
    ...
    switch ($cat) {
        ...
        case 'split':
            ...
            $s->execute([$it['item_id']]);
            $item['name'] = $s->fetchColumn() ?: 'Split Installation';
            $item['price'] = isset($it['price']) && $it['price']>0 ? $it['price'] : 0;
            break;
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="lg:col-span-2 space-y-6">
        ...
        <!-- Display all items grouped like review_order.php -->
        <?php
        $titles = [
                    ...
                    <tbody>
                        ...
                        <tr class="border-t hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-center">
                                <input type="number" value="<?= number_format($it['price'],2) ?>" class="w-20 border rounded px-2 py-1 text-center" name="price[<?= $it['id'] ?>]">
                            </td>
                            <td class="px-4 py-3 text-center">
                                <input type="number" value="<?= $it['qty'] ?>" class="w-16 border rounded px-2 py-1 text-center" name="qty[<?= $it['id'] ?>]">
                            </td>
